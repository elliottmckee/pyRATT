...
class Simulation:
    """
    (ideally) self-contained, high-level driver class for instatiating, initializing, and running an aerothermal simulation
    stores all simulation within itself, and has methods for exporting sim data as needed 
