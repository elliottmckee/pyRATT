...
class FlightData:
    ...
    Notes:
    -------
    - Only "officially" supports RASAero files rn, but if you manipulate an arbitrary .CSV
    to have the same units and column names specified below itll read in just fine
