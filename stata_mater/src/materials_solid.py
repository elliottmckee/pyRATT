"""
This File contains the Dictionary containing all the non-ablating solid material definitions. 
You can modify properties or add new materials here.

Notes:
- ALL MATERIALS PROPERTIES MUST BE INPUT IN THE UNITS SPECIFIED IN 'TEMPLATE_MATERIAL'.
- Any materials added here will automaticuall show up in the GUI
...
##### DEPRECATED - DICTIONARIES ARE WAY MORE SWAG AND PYTHONIC #####
