...
"""
This is a pretty quick "gui" (you can hardly call it that lol) I threw together. It is not super
robust, and could use a lot of work, but this is a good minumum viable product in my eyes, in
terms of making this more approachable/usable. I hope all the explanations, while wordy,
make this straightforward enough.
...
def gui_run_simulation(values):
    """ 
    Takes in GUI values, creates, runs, and outputs/pickles a Simulation 
    ...
    for i, file in enumerate(inFiles):
        ...
        # Set boundary conditions based on Aerosurface Type
...
Instructions:
    ...
    layout = [
                ...
                [sg.Text('Input RASAeroII Flight Simulation CSV: '), sg.Input(key='_INFILES_', enable_events=True, tooltip="piss"), sg.FilesBrowse()],
